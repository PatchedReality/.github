...
We're committed to giving back to the spatial computing community. 
Here are our open source tools:

| Project | Description |
|---|---|
| [Manifolder](https://github.com/PatchedReality/Manifolder) | Web-based explorer for Metaverse Spatial Fabric (MSF) map data |
| [ManifolderMCP](https://github.com/PatchedReality/ManifolderMCP) | MCP server for editing MSF scenes from Claude Code and other AI assistants |
| [ManifolderClient](https://github.com/PatchedReality/ManifolderClient) | Shared client library for connecting to MSF fabric servers |
